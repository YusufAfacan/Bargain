...
public class RoomDataExtractor : MonoBehaviour
{
    ...
    public void ProcessRooms()
    {
        ...
        foreach (Room room in dungeonData.Rooms)
        {
            ...
            room.NearWallTilesUp.ExceptWith(dungeonData.CorridorTiles);
            room.NearWallTilesDown.ExceptWith(dungeonData.CorridorTiles);
            room.NearWallTilesLeft.ExceptWith(dungeonData.CorridorTiles);
            room.NearWallTilesRight.ExceptWith(dungeonData.CorridorTiles);

            room.CornerTiles.ExceptWith(dungeonData.CorridorTiles);
            room.InnerTiles.ExceptWith(dungeonData.CorridorTiles);
